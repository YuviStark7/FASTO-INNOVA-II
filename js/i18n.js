...
var STRINGS = {
  ...
  en: {
    ...
    /* ---- names that only a screen reader ever reads ----
       Every one of these labels a control whose meaning is carried by an icon,
       a position or the surrounding layout — none of which reach someone
       listening to the page. They still have to be translated: a farmer using
       the app in Italian hears these, not the English. */
    "a11y.skip": "Skip to main content",
    "a11y.mainNav": "Main navigation",
    "a11y.authTabs": "Sign in or create an account",
    "a11y.modeTabs": "How the AI should run",
    "a11y.chatList": "Your conversations",
    "a11y.transcript": "Conversation with Fasto",
    "a11y.examples": "Example messages",
    "a11y.messageBox": "Your message to Fasto",
    "a11y.clientList": "Buyers you have a draft for",
    "a11y.openChat": "Open the conversation {title}",
    "a11y.openClient": "Open the draft for {name}",
    "a11y.changePrice": "Change the assumed price for {cat}",
    ...
    /* ---- export for reporting (ROADMAP item 12) ----
       The file that leaves the app follows the language the app is set to,
       including the CSV separator — unlike the logistics email, whose field
       names stay English because the partner reads every farmer's. */
    "export.btn": "Export",
    "export.title": "Export for reporting",
    "export.counts": "{conv} conversations · {prod} product rows · {out} outreach drafts",
    "export.researchName": "Research Progress",
    "export.outreachName": "Outreach log",
    "export.bothName": "Both, as one report",
    "export.outreachSub": "One row per draft, with the message as it was written.",
    "export.csv": "CSV",
    "export.print": "Print / PDF",
    "export.printHint": "Opens your browser's print dialog — choose “Save as PDF” as the destination.",
    "export.rowUnit": "One row per product, so a conversation offering three products appears three times.",
    "export.sepNote": "Columns are separated by “{sep}” and decimals written to match the language the app is set to, so the file opens in the right columns.",
    "export.priceNote": "Prices are desk-research assumptions, not prices any buyer has agreed, and so is every value worked out from them.",
    "export.sessionNote": "Follow-up notes and the “details changed after drafting” flag exist in this session only — they are not saved to your account.",
    "export.nothing": "There is nothing to export yet.",
    "export.done": "Saved {file}",
    "export.failed": "Your browser blocked the download.",
    "export.emptyTable": "Nothing recorded yet.",
    "export.orphanChat": "conversation not found",
    "export.noAccountName": "your account",
    "export.reportTitle": "Fasto Innova — research report",
    "export.generated": "Generated {date} · {account}",
    "export.yes": "Yes",
    "export.no": "No",
    "export.h.conversation": "Conversation",
    "export.h.date": "Date started",
    "export.h.farmer": "Farmer name",
    "export.h.village": "Village",
    "export.h.distance": "Distance from Cassino (km)",
    "export.h.organic": "Organic",
    "export.h.product": "Product",
    "export.h.category": "Category",
    "export.h.kg": "Quantity (kg/week)",
    "export.h.months": "Available months",
    "export.h.price": "Price assumption (EUR/kg)",
    "export.h.value": "Estimated weekly value (EUR, from the assumption)",
    "export.h.stage": "Stage",
    "export.h.pct": "Progress (%)",
    "export.h.drafts": "Outreach drafts written",
    "export.h.sent": "Outreach drafts sent",
    "export.h.buyer": "Buyer",
    "export.h.buyerType": "Buyer type",
    "export.h.zone": "Zone",
    "export.h.status": "Status",
    "export.h.flagged": "Flagged by the Guardian",
    "export.h.edited": "Details changed after drafting",
    "export.h.written": "Date written",
    "export.h.notes": "Follow-up notes (this session only)",
    "export.h.messageIt": "Message (Italian)",
    "export.h.messageEn": "English translation",
  ...
  it: {
    ...
    "a11y.authTabs": "Accedi o crea un account",
    "a11y.modeTabs": "Come deve funzionare l'AI",
    "a11y.chatList": "Le tue conversazioni",
    "a11y.transcript": "Conversazione con Fasto",
    "a11y.examples": "Messaggi di esempio",
    "a11y.messageBox": "Il tuo messaggio per Fasto",
    "a11y.clientList": "Acquirenti per cui hai una bozza",
    "a11y.openChat": "Apri la conversazione {title}",
    "a11y.openClient": "Apri la bozza per {name}",
    ...
    /* ---- esportazione per il report (voce 12 della ROADMAP) ---- */
    "export.btn": "Esporta",
    "export.title": "Esporta per il report",
    "export.counts": "{conv} conversazioni · {prod} righe prodotto · {out} bozze di contatto",
    "export.researchName": "Avanzamento ricerche",
    "export.outreachName": "Registro dei contatti",
    "export.bothName": "Entrambi, in un unico report",
    "export.outreachSub": "Una riga per bozza, con il messaggio come è stato scritto.",
    "export.csv": "CSV",
    "export.print": "Stampa / PDF",
    "export.printHint": "Apre la finestra di stampa del browser — scegli «Salva come PDF» come destinazione.",
    "export.rowUnit": "Una riga per prodotto: una conversazione che ne offre tre compare tre volte.",
    "export.sepNote": "Le colonne sono separate da «{sep}» e i decimali sono scritti secondo la lingua impostata nell'app, così il file si apre già diviso in colonne.",
    "export.priceNote": "I prezzi sono ipotesi da ricerca a tavolino, non prezzi concordati con un acquirente, e lo stesso vale per ogni valore che ne deriva.",
    "export.sessionNote": "Le note aggiunte e il segnale «dettagli modificati dopo la scrittura» esistono solo in questa sessione — non vengono salvati sul tuo account.",
    "export.nothing": "Non c'è ancora niente da esportare.",
    "export.done": "Salvato {file}",
    "export.failed": "Il browser ha bloccato il download.",
    "export.emptyTable": "Ancora niente da mostrare.",
    "export.orphanChat": "conversazione non trovata",
    "export.noAccountName": "il tuo account",
    "export.reportTitle": "Fasto Innova — report delle ricerche",
    "export.generated": "Generato il {date} · {account}",
    "export.yes": "Sì",
    "export.no": "No",
    "export.h.conversation": "Conversazione",
    "export.h.date": "Data di inizio",
    "export.h.farmer": "Nome dell'agricoltore",
    "export.h.village": "Paese",
    "export.h.distance": "Distanza da Cassino (km)",
    "export.h.organic": "Biologico",
    "export.h.product": "Prodotto",
    "export.h.category": "Categoria",
    "export.h.kg": "Quantità (kg a settimana)",
    "export.h.months": "Mesi di disponibilità",
    "export.h.price": "Prezzo ipotizzato (EUR/kg)",
    "export.h.value": "Valore settimanale stimato (EUR, dall'ipotesi)",
    "export.h.stage": "Fase",
    "export.h.pct": "Avanzamento (%)",
    "export.h.drafts": "Bozze di contatto scritte",
    "export.h.sent": "Bozze di contatto inviate",
    "export.h.buyer": "Acquirente",
    "export.h.buyerType": "Tipo di acquirente",
    "export.h.zone": "Zona",
    "export.h.status": "Stato",
    "export.h.flagged": "Segnalato dal Guardian",
    "export.h.edited": "Dettagli modificati dopo la scrittura",
    "export.h.written": "Data di scrittura",
    "export.h.notes": "Note aggiunte (solo in questa sessione)",
    "export.h.messageIt": "Messaggio (italiano)",
    "export.h.messageEn": "Traduzione in inglese",
